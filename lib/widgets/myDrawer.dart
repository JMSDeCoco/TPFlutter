                ...
                ElevatedButton(
                    onPressed: () {
                      FirestoreHelper()
                        ...
                        setState(() {
                          cheminImage = value;
                          profilUser.logo = cheminImage;

                          Map<String, dynamic> map = {"LOGO": cheminImage};
                          FirestoreHelper().updateUser(profilUser.uid, map);
                        });
                      });
                      Navigator.pop(context);
                    },
  ...
  Widget bodyPage() {
    return Column(
      ...
      children: [
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: (profilUser.logo != null)
                      ? NetworkImage(profilUser.logo!)
                      : NetworkImage(
        ...
        //Nom et le prénom
        Text("${profilUser.prenom} ${profilUser.nom}")
      ],
    );
  }
}
